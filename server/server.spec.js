...
describe('Test overview service', () => {
  ...
  it('It should respond to POST request with invalid product id sent to /products/:product_id', async () => {
  ...
  it('It should respond to POST request with invalid product id sent to /products/:product_id/styles', async () => {
